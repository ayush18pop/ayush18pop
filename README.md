...
Exploring **DeFi**, **protocol design**, and **smart contract security**.
...
## 📌 Featured Work
- **Stablecoin Protocol** — minimal overcollateralized stablecoin with fuzz + integration tests  
- **Lottery & NFT Contracts** — Solidity implementations with clean architecture  
- **Eth API Payments** — SDK to charge for APIs using zk-verified usage (contributor)

---

## 📈 Current Focus
- Advanced Solidity patterns & security  
- DeFi primitives  
